 ...
 * 
 * Implementation of the K-medoids clustering algorithm as by Hui Ye and Steve Young, "A clustering approach to semantic decoding." INTERSPEECH. 2006. *
 * with some small changes and adjustments 
 */
public abstract class AbstractKmedoidsClusterer<T> {
	...
	public AbstractKmedoidsClusterer(boolean useExpandedCollection, WeightType weightType, Double similarityThreshold) {
